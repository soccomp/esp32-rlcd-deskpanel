 ...
 *  - 四张独立机械页片式翻页钟（上下页缝 + 双侧铰链）+ 日期星期（中文）
 *  - 状态栏：日期+中文星期、农历日期（8-13 起替代原法语短句）
 *  - 左：室内外气象卡（左半 SHTC3 室内大字温湿度 | 右半 今日/明日天气）
 *  - 右上：股票指数行情卡（上证/沪深300/创业板指）
 *  - 右下：法语学习卡（随机两条法语+中文翻译，每 5 分钟切换，8-13 替代摄像头缩略）
 *  - 1s 定时器从 PCF85063A RTC 读时；5s 定时器读 SHTC3；300s 定时器换法语句子
